...
function energyBadge(rating) {
    ...
    // Expose getFilters globally for the MI dashboard
    ...
    const fetchProperties = async (filters) => {
        try {
            ...
            // Fetch MI dashboard data if available
            if (typeof window.fetchMarketIntelligence === 'function' && window.isMIViewActive && window.isMIViewActive()) {
                window.fetchMarketIntelligence();
            }
        } catch (error) {
